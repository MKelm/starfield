...
SF.Version.prototype.constructor = SF.Version;

SF.Version.prototype.getCommitHash = function(callback) {
  var fs = require('fs');
...
SF.Version.prototype.getVersionHash = function(callback) {
...
SF.Version.prototype.updateHashesFile = function() {
  var hashes = './HASHES';
  var fs = require('fs');
  var scope = this;
