...
SF.Util.prototype.constructor = SF.Util;

SF.Util.prototype.getEventListener = function(obj, func) {
  return function(event) { obj[func](obj, event); };
}

SF.Util.prototype.quit = function(delay) {
...
SF.Util.prototype.loadJSON = function(json, forceLoad) {
  var result = {};
...
SF.Util.prototype.objectLength = function(object) {
  var size = 0, key;
  for (key in object) {
...
SF.Util.prototype.time = function(type, delay) {
  var div = 1;
  if (type == "unix") {
    div = 1000;
  }
